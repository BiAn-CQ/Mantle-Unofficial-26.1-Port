...
public class JsonHelper {
  ...
  public static JsonElement serializeConditions(ICondition... conditions) {
    return ICondition.LIST_CODEC.encodeStart(JsonOps.INSTANCE, List.of(conditions)).getOrThrow();
  }
  ...
  public static List<ICondition> deserializeConditions(JsonElement json) {
    return ICondition.LIST_CODEC.parse(JsonOps.INSTANCE, json).getOrThrow();
  }
  ...
  private static final class IdentifierAdapter implements JsonSerializer<Identifier>, JsonDeserializer<Identifier> {
    ...
    public Identifier deserialize(JsonElement json, java.lang.reflect.Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      return parseIdentifier(json.getAsString(), "identifier");
    }
  }
