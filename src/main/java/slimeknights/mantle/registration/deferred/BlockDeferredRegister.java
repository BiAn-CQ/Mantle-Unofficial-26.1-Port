...
public class BlockDeferredRegister extends DeferredRegisterWrapper<Block> {
  /** Registry key of the block supplier currently being evaluated. */
  ...
  public BlockDeferredRegister(String modID) {
    super(DeferredRegister.createBlocks(modID), modID);
  ...
  /**
   * Gets the block key for the supplier currently being evaluated.  Tinkers
   * uses this to initialize 26.1 block properties before the Block constructor
   * reads its effective drops and description.
   */
  public static ResourceKey<Block> currentBlockId() {
    return CURRENT_BLOCK_ID.get();
  }

  /** Binds block properties to the block supplier currently being evaluated. */
  public static BlockBehaviour.Properties bindBlockProperties(BlockBehaviour.Properties properties) {
    ResourceKey<Block> blockId = CURRENT_BLOCK_ID.get();
    return blockId == null ? properties : properties.setId(blockId);
  }

  private ResourceKey<Block> blockKey(String name) {
    return ResourceKey.create(Registries.BLOCK, resource(name));
  }

  private <B extends Block> Supplier<B> withCurrentBlockId(String name, Supplier<? extends B> block) {
    return withCurrentBlockId(blockKey(name), block);
  }

  /** Wraps a block supplier registered by another deferred register with its real block key. */
  public static <B extends Block> Supplier<B> withCurrentBlockId(String modID, String name, Supplier<? extends B> block) {
    return withCurrentBlockId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(modID, name)), block);
  }

  private static <B extends Block> Supplier<B> withCurrentBlockId(ResourceKey<Block> blockId, Supplier<? extends B> block) {
    return () -> {
  ...
  public <B extends Block> DeferredHolder<Block, B> registerNoItem(String name, Supplier<? extends B> block) {
    return register.register(name, withCurrentBlockId(name, block));
  }
  ...
  public DeferredHolder<Block, Block> registerNoItem(String name, BlockBehaviour.Properties props) {
    return registerNoItem(name, () -> new Block(props.setId(blockKey(name))));
  }
  ...
  public <B extends Block> ItemObject<B> register(String name, Supplier<? extends B> block, final Function<? super B, ? extends BlockItem> item) {
    ...
    itemRegister.register(name, ItemDeferredRegister.withCurrentItemId(modID, name, () -> item.apply(blockObj.get())));
  ...
  public ItemObject<Block> register(String name, BlockBehaviour.Properties blockProps, Function<? super Block, ? extends BlockItem> item) {
    return register(name, () -> new Block(blockProps.setId(blockKey(name))), item);
  }
  ...
  public BuildingBlockObject registerBuilding(String name, Supplier<? extends Block> block, Function<? super Block, ? extends BlockItem> item) {
    ...
    return new BuildingBlockObject(
        blockObj,
        this.register(name + "_slab", () -> new SlabBlock(bindBlockProperties(BlockBehaviour.Properties.ofFullCopy(blockObj.get()))), item),
        this.register(name + "_stairs", () -> new StairBlock(blockObj.get().defaultBlockState(), bindBlockProperties(BlockBehaviour.Properties.ofFullCopy(blockObj.get()))), item));
  }
  ...
  public BuildingBlockObject registerBuilding(String name, BlockBehaviour.Properties props, Function<? super Block, ? extends BlockItem> item) {
    ...
    return new BuildingBlockObject(blockObj,
      register(name + "_slab", () -> new SlabBlock(bindBlockProperties(props)), item),
      register(name + "_stairs", () -> new StairBlock(blockObj.get().defaultBlockState(), bindBlockProperties(props)), item)
    );
  }
  ...
  public WallBuildingBlockObject registerWallBuilding(String name, Supplier<? extends Block> block, Function<? super Block, ? extends BlockItem> item) {
    ...
    return new WallBuildingBlockObject(obj, this.register(name + "_wall", () -> new WallBlock(bindBlockProperties(BlockBehaviour.Properties.ofFullCopy(obj.get()))), item));
  }
  ...
  public WallBuildingBlockObject registerWallBuilding(String name, BlockBehaviour.Properties props, Function<? super Block, ? extends BlockItem> item) {
    return new WallBuildingBlockObject(
      ...
      register(name + "_wall", () -> new WallBlock(bindBlockProperties(props)), item)
    );
  }
  ...
  public FenceBuildingBlockObject registerFenceBuilding(String name, Supplier<? extends Block> block, Function<? super Block, ? extends BlockItem> item) {
    BuildingBlockObject obj = this.registerBuilding(name, block, item);
    return new FenceBuildingBlockObject(obj, this.register(name + "_fence", () -> new FenceBlock(bindBlockProperties(BlockBehaviour.Properties.ofFullCopy(obj.get()))), item));
  }
  ...
  public FenceBuildingBlockObject registerFenceBuilding(String name, BlockBehaviour.Properties props, Function<? super Block, ? extends BlockItem> item) {
    return new FenceBuildingBlockObject(
      registerBuilding(name, props, item),
      register(name + "_fence", () -> new FenceBlock(bindBlockProperties(props)), item)
    );
  }
  ...
  public WoodBlockObject registerWood(String name, Function<WoodVariant,BlockBehaviour.Properties> behaviorCreator, boolean flammable) {
    ...
    if (flammable) {
      burnableItem     = burnTime -> block -> new BurnableBlockItem(block, ItemDeferredRegister.bindItemProperties(itemProps), burnTime);
      burnableTallItem = block -> new BurnableTallBlockItem(block, ItemDeferredRegister.bindItemProperties(itemProps), 200);
      burnableSignItem = (standing, wall) -> new BurnableSignItem(ItemDeferredRegister.bindItemProperties(signProps), standing, wall, 200);
      burnableHangingSignItem = (standing, wall) -> new BurnableHangingSignItem(ItemDeferredRegister.bindItemProperties(signProps), standing, wall, 200);
    } else {
      Function<? super Block, ? extends BlockItem> defaultItemBlock = block -> new BlockItem(block, ItemDeferredRegister.bindItemProperties(itemProps));
      burnableItem = burnTime -> defaultItemBlock;
      burnableTallItem = block -> new DoubleHighBlockItem(block, ItemDeferredRegister.bindItemProperties(itemProps));
      burnableSignItem = (standing, wall) -> new SignItem(standing, wall, ItemDeferredRegister.bindItemProperties(signProps));
      burnableHangingSignItem = (standing, wall) -> new HangingSignItem(standing, wall, ItemDeferredRegister.bindItemProperties(signProps));
    }
    ...
    ItemObject<FenceBlock> fence = register(name + "_fence", () -> new FenceBlock(bindBlockProperties(Properties.ofFullCopy(planks.get()).forceSolidOn())), burnable300);
    // logs and wood
    ...
    ItemObject<FenceGateBlock> fenceGate = register(name + "_fence_gate", () -> new FenceGateBlock(woodType, bindBlockProperties(BlockBehaviour.Properties.ofFullCopy(fence.get()))), burnable300);
    // redstone
    ...
    ItemObject<PressurePlateBlock> pressurePlate = register(name + "_pressure_plate", () -> new PressurePlateBlock(setType, bindBlockProperties(redstoneProps)), burnable300);
    ItemObject<ButtonBlock> button = register(name + "_button", () -> new ButtonBlock(setType, 30, bindBlockProperties(redstoneProps)), burnableItem.apply(100));
    // signs
    ...
    this.itemRegister.register(name + "_sign", ItemDeferredRegister.withCurrentItemId(modID, name + "_sign", () -> burnableSignItem.apply(standingSign.get(), wallSign.get())));
    this.itemRegister.register(name + "_hanging_sign", ItemDeferredRegister.withCurrentItemId(modID, name + "_hanging_sign", () -> burnableHangingSignItem.apply(hangingSign.get(), wallHangingSign.get())));
    // finally, return
  ...
  public DeferredHolder<Block, FlowerPotBlock> registerPotted(String name, Supplier<? extends Block> block) {
    DeferredHolder<Block, FlowerPotBlock> potted = registerNoItem("potted_" + name, () -> new FlowerPotBlock(
      () -> (FlowerPotBlock)Blocks.FLOWER_POT, block,
      bindBlockProperties(BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY))));
  ...
  public MetalItemObject registerMetal(String name, String tagName, Supplier<Block> blockSupplier, Function<Block,? extends BlockItem> blockItem, Item.Properties itemProps) {
    ...
    Supplier<Item> itemSupplier = () -> new Item(ItemDeferredRegister.bindItemProperties(itemProps));
    DeferredHolder<Item, Item> ingot = itemRegister.register(name + "_ingot", ItemDeferredRegister.withCurrentItemId(modID, name + "_ingot", itemSupplier));
    DeferredHolder<Item, Item> nugget = itemRegister.register(name + "_nugget", ItemDeferredRegister.withCurrentItemId(modID, name + "_nugget", itemSupplier));
  ...
  public MetalItemObject registerMetal(String name, String tagName, BlockBehaviour.Properties blockProps, Function<Block,? extends BlockItem> blockItem, Item.Properties itemProps) {
    return registerMetal(name, tagName, () -> new Block(blockProps.setId(blockKey(name + "_block"))), blockItem, itemProps);
  }
