...
public class ContentListing extends PageContent {
  ...
  public int getEntriesInColumn(SectionData sectionData) {
    ...
    if (this.subText != null) {
      yOff += sectionData.parent.fontRenderer.wordWrapHeight(Component.literal(this.subText), BookScreen.PAGE_WIDTH) * 12 / 9;
    }
  ...
  public HtmlSerializable toHTML(BookData book) {
    ...
    if (!entries.isEmpty()) {
      ...
      if (this.subText != null) yOff += book.fontRenderer.wordWrapHeight(Component.literal(subText), BookScreen.PAGE_WIDTH) * 12 / 9;
