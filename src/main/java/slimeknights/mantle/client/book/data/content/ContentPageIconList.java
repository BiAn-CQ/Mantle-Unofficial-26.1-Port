...
public class ContentPageIconList extends PageContent {
  ...
  public int getMaxRows() {
    ...
    if (subText != null) {
      totalHeight -= 16 + this.parent.parent.parent.fontRenderer.wordWrapHeight(Component.literal(subText), BookScreen.PAGE_WIDTH) * 12 / 9;
    }
  ...
  public HtmlSerializable toHTML(BookData book) {
    ...
    if (this.subText != null) yOff = book.fontRenderer.wordWrapHeight(Component.literal(this.subText), 182) * 12 / 9 + 16;
