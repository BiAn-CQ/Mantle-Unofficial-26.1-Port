...
public class InventoryBlockEntityRenderer<T extends BlockEntity & Container> implements BlockEntityRenderer<T,InventoryRenderState> {
  ...
  public void extractRenderState(T inventory, InventoryRenderState renderState, float partialTicks, Vec3 cameraPosition,
    ...
    List<RenderItem> placements = RenderItem.STATE_REGISTRY.get(state, List.of());
