...
public class PredicateRegistry<T> extends DefaultingLoaderRegistry<IJsonPredicate<T>> {
  ...
  public PredicateRegistry(String name, IJsonPredicate<T> anyInstance, @Nullable IJsonPredicate<T> noneInstance) {
    ...
    invertedLoader = RecordLoadable.create(directField("inverted_type", InvertedJsonPredicate::predicate), InvertedJsonPredicate::new);
    andLoader = RecordLoadable.create(list.requiredField("predicates", AndJsonPredicate::children), AndJsonPredicate::new);
    orLoader = RecordLoadable.create(list.requiredField("predicates", OrJsonPredicate::children), OrJsonPredicate::new);
  ...
  public class InvertedJsonPredicate implements IJsonPredicate<T> {
    ...
    public IJsonPredicate<T> predicate() {
      return predicate;
    }
  ...
  public class AndJsonPredicate implements IJsonPredicate<T> {
    ...
    public List<IJsonPredicate<T>> children() {
      return children;
    }
